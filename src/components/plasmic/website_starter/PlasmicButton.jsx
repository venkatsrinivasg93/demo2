...
import sty from "./PlasmicButton.module.css"; // plasmic-import: PCWdn5kOt7qV/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: QJTGrep3u848/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Csp9RkVwugai/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ftZr5)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__llOIl)}
                role={"img"}
              />
            ),
