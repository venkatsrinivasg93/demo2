...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: n7gWFPI8VLbC/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: iDEuC4C3rQ6c/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: QJTGrep3u848/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__vwrfr)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__f2Mro)}
              role={"img"}
            />
          ),
